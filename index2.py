...
class Desk:
    def __init__(self, window):
        ...
        frame = LabelFrame(self.wind, text = 'Operaciones')
        frame.grid(row = 0, column = 0, columnspan = 3, pady = 20)

        # creamos un contenedor
        #frame1 = LabelFrame(self.wind, text = 'Sumar 2 valores')
        ...
        #Creamos un boton para ejecutar la multiplicación
        Button(frame, text = 'Multiplicar', command = self.multiplicar).grid(row = 5, columnspan = 2, sticky = W + E)

        #Creamos un boton para ejecutar la División
